<?php
$headers = array(
	array($lang->lang('th_vs_id'), 'vs_id'),
	array($lang->lang('th_vs_name'), 'vs_name'),
	array($lang->lang('th_date'), 'vs_date'),
	array($lang->lang('th_vs_expire_date'), 'vs_expire_date'),
	array($lang->lang('th_vs_min'), 'vs_min'),
	array($lang->lang('th_vs_max'), 'vs_max'),
	array($lang->lang('th_vs_avg'), 'vs_avg'),
	array($lang->lang('th_vs_sum'), 'vs_sum'),
	array($lang->lang('th_vs_count'), 'vs_count'),
);
